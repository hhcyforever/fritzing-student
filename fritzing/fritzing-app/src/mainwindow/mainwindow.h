...
extern vector<simple_item> itemsStruct;
extern vector<simple_item> itemsStruct2;
...
public:
    ...
    void MouseMoveNotify(QMouseEvent *e);
    ...
    void OnNewPraise(std::string const& name,message::ptr const& data,bool hasAck,message::list &ack_resp);
    void OnNewHighlight(std::string const& name,message::ptr const& data,bool hasAck,message::list &ack_resp);
...
signals:
    ...
    void MsgSignal(QString a);
    void PraiseSignal(QString a);
    void HighlightSignal(qreal n1,qreal n2,qreal n3,qreal n4);
public slots:

    void showShadow(qreal n1,qreal n2,qreal n3,qreal n4);
    void showShadow2();
    void slotGrabWidgetScreen();
    void showMsg(QString a);
    void showPraise(QString a);
	void ensureClosable();
