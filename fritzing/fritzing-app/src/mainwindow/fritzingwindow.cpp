...
//    socket::ptr sock = _io->socket("/student");
//    BIND_EVENT(sock,"praise",std::bind(&FritzingWindow::OnNewMessage,this,_1,_2,_3,_4));
...
//void FritzingWindow::OnNewMessage(std::string const& name,message::ptr const& data,bool hasAck,message::list &ack_resp){
//    std::string a = "try";
//    //QMessageBox::information(this, QString::fromStdString(a),QString::fromStdString(data->get_string()));
//    MsgDlg dlg(Msg_Praise,QString::fromStdString(data->get_string()),this->window());
